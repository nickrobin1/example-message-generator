  ...
  "industries": [
    {
      ...
      "steps": {
        "Email": {
          ...
          "Prompt": "Write a welcome email that includes a 15% coupon code and encourages the user to return and complete their purchase."
        },
        "SMS": {
          "Goal": "Recover cart with quick reminder",
          "Prompt": "Create a short SMS that references the user's last viewed items and includes the 15% discount code."
        },
        "Push": {
          "Goal": "Confirm order shipment or delivery",
          "Prompt": "Craft a push notification letting the user know their order has shipped or is out for delivery."
        },
        "In-App": {
          "Goal": "Capture user contact information",
          "Prompt": "Create an in-app message that offers a 15% discount code in exchange for the user providing their email and phone number to enable personalized shopping updates.",
    ...
    },
    {
      ...
      "steps": {
        ...
        "Content Card": {
          ...
          "Prompt": "Create an content card promoting popular items and reminding user they can apply their promo code."
        },
        "Push": {
